...
-- 
ALTER TABLE grustoragedb_notification_backoffice DROP CONSTRAINT fk_grustoragedb_notification_backoffice_notification_id;
ALTER TABLE grustoragedb_notification_sms DROP CONSTRAINT fk_grustoragedb_notification_sms_notification_id;
ALTER TABLE grustoragedb_notification_customer_email DROP CONSTRAINT fk_grustoragedb_notification_customer_email_notification_id;
ALTER TABLE grustoragedb_notification_mydashboard DROP CONSTRAINT fk_grustoragedb_notification_mydashboard_notification_id;
ALTER TABLE grustoragedb_notification_broadcast_email DROP CONSTRAINT fk_grustoragedb_notification_broadcast_email_notification_id;
